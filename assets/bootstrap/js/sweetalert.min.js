!function(a, b) {
    function c(b) {
        ...
        b.type) {
            ...
            if (!h)
                return a.console.error("Unknown alert type: " + b.type),
                !1;
    ...
    a.sweetAlert = a.swal = function() {
        function h(a) {
            ...
            if (-1 !== [9, 13, 32, 27].indexOf(b)) {
                ...
                9 === b ? (c = -1 === d ? u : d === w.length - 1 ? w[0] : w[d + 1],
                E(a),
                c.focus()) : (c = 13 === b || 32 === b ? -1 === d ? u : void 0 : 27 !== b || v.hidden || "none" === v.style.display ? void 0 : v,
                void 0 !== c && D(c, a))
            }
        }
        function l(a) {
        ...
        if (void 0 === arguments[0])
            return a.console.error("sweetAlert expects at least 1 attribute!"),
            !1;
        var m = d({}, o);
        ...
        case "object":
            if (void 0 === arguments[0].title)
                return a.console.error('Missing "title" argument!'),
                !1;
    ...
    function() {
        "complete" === b.readyState || "interactive" === b.readyState && b.body ? sweetAlertInitialize() : b.addEventListener ? b.addEventListener("DOMContentLoaded", function a() {
            ...
            "complete" === b.readyState && (b.detachEvent("onreadystatechange", c),
            sweetAlertInitialize())
        })
    }()
}(window, document);
